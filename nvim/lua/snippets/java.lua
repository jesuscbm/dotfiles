...
ls.add_snippets("java", {
    ...
    s("setter", {
        ...
        t({ "", "    this." }), f(function(args) return args[1][1] end, { 2 }), t(" = "), f(
    function(args) return args[1][1] end, { 2 }), t(";"),
        t({ "", "}" }),
    }),
    ...
    -- Parameters
    s("param", {
        t({ "@param " }), i(1, "paramName"), t(" "), i(2, "Description"),
    }),
    -- Throws
    s("throws", {
        t({ "@throws " }), i(1, "Exception"), t(" "), i(2, "If what"),
    }),
