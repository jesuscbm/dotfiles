...
ROFI_CONFIG="~/.config/rofi/wifi.rasi"
...
CHENTRY=$(echo -e "$TOGGLE\nmanual\n$LIST" | uniq -u | rofi -dmenu -p "Wi-Fi SSID: " -lines "$LINENUM" -a "$HIGHLINE" -location "$POSITION" -yoffset "$YOFF" -xoffset "$XOFF" -config "$ROFI_CONFIG" )
#echo "$CHENTRY"
